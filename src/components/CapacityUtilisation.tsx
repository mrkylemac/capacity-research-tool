      ...
      <CardContent className="p-5">
        ...
        <div className="h-48">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={visitorsChartData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
              ...
              <Bar dataKey="visitors" radius={[4, 4, 0, 0]}>
                {visitorsChartData.map((entry, index) => (
                  <Cell
                    key={index}
        ...
        <p className="text-xs text-muted-foreground text-center mt-2">
          Bar colour reflects utilisation: green (&ge;70%), amber (&ge;40%), red (&lt;40%)
        </p>
      </CardContent>
    </Card>
  );
