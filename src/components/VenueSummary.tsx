...
export function VenueSummary({ metrics, venueConfig, monthlyData, hostInfo, dateRange }: VenueSummaryProps) {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex flex-row gap-4">
            ...
            <div className="flex-1 min-w-0 space-y-3">
              <div>
                ...
                <div className="flex flex-wrap items-center gap-x-2 gap-y-0.5 text-base sm:text-base text-muted-foreground mt-0.5">
      ...
      {/* 6 Insight Cards */}
      <div>
        <p className="text-base font-medium text-muted-foreground uppercase tracking-wider mb-3">Key Insights</p>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">

          <Card className="border-l-4 border-l-blue-500">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-start justify-between">
                <p className="text-base text-muted-foreground leading-tight">Total Visitors</p>
              ...
              <p className="text-base sm:text-base text-muted-foreground mt-1 leading-tight">
          ...
          <Card className="border-l-4 border-l-blue-400">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-start justify-between">
                <p className="text-base text-muted-foreground leading-tight">Avg Weekly</p>
          ...
          <Card className={`border-l-4 ${occupancyAccent}`}>
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-start justify-between">
                <p className="text-base text-muted-foreground leading-tight">Occupancy</p>
          ...
          <Card className="border-l-4 border-l-green-500">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-start justify-between">
                <p className="text-base text-muted-foreground leading-tight">Peak Month</p>
              ...
              {peakMonth ? (
                <>
                  ...
                  <div className="flex flex-wrap items-center gap-1 mt-1">
                    <Badge variant="secondary" className="text-base px-1.5 py-0">
                      {peakMonth.month.slice(0, 3)} {peakMonth.year}
                    </Badge>
                    <span className="text-base sm:text-base text-muted-foreground">{peakMonth.sessions} sessions</span>
                  </div>
                </>
              ) : (
          ...
          <Card className={`border-l-4 ${hasTrend && trendPct! >= 0 ? 'border-l-green-500' : hasTrend ? 'border-l-amber-500' : 'border-l-muted'}`}>
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-start justify-between">
                <p className="text-base text-muted-foreground leading-tight">Trend</p>
                {hasTrend
                  ? trendPct! >= 0
              ...
              {hasTrend ? (
                ...
                <>
                  <p className="text-2xl sm:text-3xl font-bold mt-1 text-muted-foreground">—</p>
                  <p className="text-base sm:text-base text-muted-foreground mt-1">Need 4+ months</p>
                </>
              )}
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-l-violet-400">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-start justify-between">
                <p className="text-base text-muted-foreground leading-tight">Demand Split</p>
              ...
              <p className="text-base font-semibold text-muted-foreground -mt-0.5">{dominantDay}</p>
              ...
              <div className="flex justify-between mt-1">
                <span className="text-base text-muted-foreground flex items-center gap-0.5">
